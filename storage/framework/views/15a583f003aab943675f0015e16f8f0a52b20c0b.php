...
<script>
    let url = '<?php echo e(route("taxable-bet-list")); ?>';
                                                    ...
                                                    <div class="bc-dropdown-container-body clear-padding">
                                                        <div class="filters-grid">
                                                            ...
                                                            <ul class="filter-action-buttons">
                                                                <li><button id="submit" data-i18n="_Apply_" bc-auto-focus="true"><?php echo e(__('apply')); ?></button>
                                                                    <button data-i18n="_Reset_" ng-click="resetFilter()" type="button"><?php echo e(__('reset')); ?></button>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="adv-table-scroll-overflow">
                                                ...
                                                <div class=" col-xs-12 col-md-12 col-lg-12 ng-scope ng-isolate-scope">
                                                    <div class="bc-dashboard-widget ng-isolate-scope bc-separate-loading-element">
                                                        <div class="widget-header">
                                                            <span class="widget-title">
                                                                <span class="ng-binding ng-scope">SportBook Taxable Bet Report</span>
                                                            </span>
...
<!---<a href="#" id="exportButton" class="btn btn-success" style="color:white;">
    Export Users
</a> -------->
...
<script>
 ...
 $(document).ready(function() {
        $('#exportButton').on('click', function(e) {
            ...
            const betId = $('[name=bet_id]').val() || '';

            // Build the export URL
            const baseUrl = "<?php echo e(route('exportSportBook')); ?>"; // Base URL without parameters
            const exportUrl = `${baseUrl}?start_date=${encodeURIComponent(startDate)}&end_date=${encodeURIComponent(endDate)}&bet_id=${encodeURIComponent(betId)}`;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\backoffice.bantubet.com\backoffice-ao.bantubet.com\resources\views/taxable-bet.blade.php ENDPATH**/ ?>