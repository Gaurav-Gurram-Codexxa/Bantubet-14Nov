...
<script>
    let url = '<?php echo e(route("casino-taxable-bet-list")); ?>';
                                                            ...
                                                            <ul ng-if="filterIsReady" class="ng-scope">
                                                              	<li>
                                                                    <label class="label-holder">
                                                                        <p data-i18n="_PlayerId_"><?php echo e(__('player_id')); ?></p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\backoffice.bantubet.com\backoffice-ao.bantubet.com\resources\views/casino-taxable-bet.blade.php ENDPATH**/ ?>