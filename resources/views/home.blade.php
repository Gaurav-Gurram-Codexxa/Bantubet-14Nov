         ...
         <div class="action-toolbar-row col-xs-12">
               ...
               <div class="bc-dashboard-widget ng-isolate-scope bc-separate-loading-element">
                  <div class="widget-header">
                     <span class="widget-title">
                        <span class="">{{__('sportbook_overview')}}</span>
                     </span>
                           ...
                           <div class="widget-table">
                              ...
                              <div class="widget-table-row widget-header-row clearfix">
                                 ...
                                 <div class="widget-table-cell widget-header-cell " style="font-size: 1em;">
                                    <span class="">{{__('online')}}</span>
                                 </div>

                                 <div class="widget-table-cell widget-header-cell " style="font-size: 1em;"><span class="">{{__('retail')}}</span></div>

                                 <div class="widget-table-cell widget-header-cell " style="font-size: 1em;"><span class="">{{__('total')}}</span></div>

                              </div>
                              <div class="widget-table-row widget-body-row clearfix ">
                                 <div class="widget-table-cell widget-title-col" style="font-size: 1em;"><span class="">{{__('revenue')}}</span></div>
                              ...
                              <div class="widget-table-row widget-body-row clearfix ">
                                 <div class="widget-table-cell widget-title-col" style="font-size: 1em;"><span class="">{{__('winning')}}</span></div>
                              ...
                              <div class="widget-table-row widget-body-row clearfix ">
                                 <div class="widget-table-cell widget-title-col" style="font-size: 1em;"><span class="">{{__('ggr')}}</span></div>
                              ...
                              <div class="widget-table-row widget-body-row clearfix ">
                                 <div class="widget-table-cell widget-title-col" style="font-size: 1em;"><span class="">{{__('ggr_tax')}}</span></div>
                              ...
                              <div class="widget-table-row widget-body-row clearfix ">
                                 <div class="widget-table-cell widget-title-col" style="font-size: 1em;"><span class="">{{__('taxable_winning_bets')}}</span></div>
                              ...
                              <div class="widget-table-row widget-body-row clearfix ">
                                 <div class="widget-table-cell widget-title-col" style="font-size: 1em;"><span class="">{{__('winning_tax')}}</span></div>
                              ...
                              <div class="widget-table-row widget-body-row clearfix ">
                                 <div class="widget-table-cell widget-title-col" style="font-size: 1em;"><span class="">{{__('number_bets')}}</span></div>
                              ...
                              <div class="widget-table-row widget-body-row clearfix ">
                                 <div class="widget-table-cell widget-title-col" style="font-size: 1em;"><span class="">{{__('number_winning')}}</span></div>
                              ...
                              <div class="widget-footer-row widget-table-row ">
                                 <div class="widget-footer-cell " style="font-size: 1em;">{{__('single')}}: <span class="c-sngl">N/A</span></div>
                                 <div class="widget-footer-cell " style="font-size: 1em;">{{__('multiple')}}: <span class="c-mltpl">N/A</span></div>
                                 <div class="widget-footer-cell " style="font-size: 1em;">{{__('system')}}: <span class="c-systm">N/A</span></div>
                                 <div class="widget-footer-cell " style="font-size: 1em;">{{__('chain')}}: <span class="c-chn">N/A</span></div>
            ...
            <div class="col-xs-12 col-md-12 col-lg-12  ng-isolate-scope">
               <div class="bc-dashboard-widget ng-isolate-scope bc-separate-loading-element">
                  <div class="widget-header">
                     <span class="widget-title">
                        <span class="">{{__('casino_overview')}}</span>
                     </span>
                        ...
                        <div class="ng-isolate-scope">
                           <div class="widget-table">
                              ...
                              <div class="widget-table-row widget-header-row clearfix">
                                 ...
                                 <div class="widget-table-cell widget-header-cell " style="font-size: 1em;"><span class="">{{__('live_casino')}}</span></div>

                                 <div class="widget-table-cell widget-header-cell " style="font-size: 1em;"><span class="">{{__('Slots')}}</span></div>
                              ...
                              <div class="widget-table-row widget-body-row clearfix ">
                                 <div class="widget-table-cell widget-title-col" style="font-size: 1em;"><span class="">{{__('ggr_tax')}}
                                    </span></div>
