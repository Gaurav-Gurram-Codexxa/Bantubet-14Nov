                                                               ...
                                                               <ul ng-if="filterIsReady" class="ng-scope">
                                                                   <li>
                                                                       <label class="label-holder">
                                                                           <p data-i18n="_PlayerId_">{{__('bet_id')}}</p>
                                                                           <input-wrapper
                                          ...
                                          <div class="adv-table-scroll-overflow">
                                             ...
                                             <div class=" col-xs-12 col-md-12 col-lg-12 ng-scope ng-isolate-scope">
                                                <div class="bc-dashboard-widget ng-isolate-scope bc-separate-loading-element">
                                                    <div class="widget-header">
                                                        <span class="widget-title">
                                                            <span class="ng-binding ng-scope">{{__('report_sport_book')}}</span>
                                                        </span>
                                                        ...
                                                        <table id="example" class="table table-striped table-bordered display nowrap" cellspacing="0" width="100%">
                                                            <thead style="background-color: #f0f5f8;">
                                                                <tr>
                                                                    <th>{{__('bet_id')}}</th>
                                                                    <th>{{__('player_id')}}</th>
                                                                    <th>{{__('stake')}} ({{$currency}})</th>
                                                                    <th>{{__('possible_winning')}}</th>
                                                                    <th>{{__('selection_count')}}</th>
                                                                    <th>{{__('odds')}}</th>
                                                                    <th>{{__('winning')}} ({{$currency}})</th>
                                                                    <th>{{__('type')}}</th>
                                                                    <th>{{__('ggr')}} ({{$currency}})</th>
                                                                    <th>{{__('state')}}</th>
                                                                    <th>{{__('created')}}</th>
...
<script>
	...
	$(document).ready(function () {
		...
		$('input[name="daterangepicker"]').daterangepicker({
			...
			ranges:
			{
				"{{__('today')}}": [moment().hour(0).minute(0), moment().add(1, 'days').hour(0).minute(0)],
				"{{__('yesterday')}}": [moment().subtract(1, 'days').hour(0).minute(0), moment().hour(0).minute(0)],
				"{{__('last_7_days')}}": [moment().subtract(6, 'days').hour(0).minute(0), moment().add(1, 'days').hour(0).minute(0)],
				"{{__('last_30_days')}}": [moment().subtract(29, 'days').hour(0).minute(0), moment().hour(0).minute(0)],
				"{{__('this_month')}}": [moment().startOf('month').hour(0).minute(0), moment().endOf('month').hour(0).minute(0)],
				"{{__('last_month')}}": [moment().subtract(1, 'month').startOf('month').hour(0).minute(0), moment().subtract(1, 'month').endOf('month').hour(0).minute(0)]
			}
