                                            ...
                                            <div class="adv-table-scroll-overflow">
                                                ...
                                                <div class=" col-xs-12 col-md-12 col-lg-12 ng-scope ng-isolate-scope">
                                                    <div class="bc-dashboard-widget ng-isolate-scope bc-separate-loading-element">
                                                        <div class="widget-header">
                                                            <span class="widget-title">
                                                                <span class="ng-binding ng-scope">{{__('report-tax')}}</span>
                                                            </span>
                                                            ...
                                                            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                                <thead style="background-color: #f0f5f8;">
                                                                    <tr>
                                                                        <th>{{__('product')}}</th>
                                                                        <th>{{__('bets')}}</th>
                                                                        <th>{{__('stakes')}}({{$currency}})</th>
                                                                        <th>{{__('cancel_stakes')}}({{$currency}})</th>
                                                                        <th>{{__('net_stakes')}}({{$currency}})</th>
                                                                        <!-- <th>Free Bet Winning({{$currency}})</th> -->
                                                                        <th>{{__('winning')}}({{$currency}})</th>
                                                                        <!-- <th>turnover Tax({{$currency}})</th> -->
