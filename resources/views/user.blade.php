                ...
                <div class="bc-dashboard-widget ng-isolate-scope bc-separate-loading-element">
                    <div class="widget-header">
                        <span class="widget-title">
                            <span class="ng-binding ng-scope">{{__('users')}}</span>
                        </span>
                    ...
                    <div class="action-toolbar-row">
                        ...
                        <div class="right-actions"><button class="button-type-hero" onclick="createNewUser()" data-i18n="_AddPlayer_">{{__('add_user')}}</button></div>
                    </div>
                    ...
                    <div class="bc-separate-loader-container"><img class="bc-separate-loader" style="width: 90px; height: 90px" src="{{ asset('assets/img/loader.gif')}}" alt="loader"></div>
                </div>
            </div>
...
<dialog id="user">
    <div class="modal-content" ng-transclude="">
        <div class="pdh-header ">
            ...
            <span data-i18n="_Settings_">{{__('user')}}</span>
        </div>
                    ...
                    <ul>
                        <li>
                            <div class="form-group">
                                <label for="currency_for_report">{{__('name')}}</label>
                        ...
                        <li>
                            <div class="form-group">
                                <label for="currency_for_report">{{__('email')}}</label>
                                <div class="form-group">
                        ...
                        <li>
                            <div class="form-group">
                                <label for="currency_for_report">{{__('password')}}</label>
                                <div class="form-group">
                        ...
                        <li>
                            <div class="form-group">
                                <label for="is_admin"><input type="checkbox" name="is_admin" value="1" id="is_admin" class="bcInputClass">{{__('is_admin')}}</label>
                            </div>
                        </li>
...
<dialog id="confirm">
    <div class="modal-content" ng-transclude="">
        ...
        <form id="delete-form" method="post">
            <div class="pdh-content">
                <div class="filters-grid settings-grid">
				<span data-i18n="_Settings_">{{__('are_you_sure')}}</span>
                </div>
            </div>
            <div class="pdh-buttons-holder">
                <div>
...
<script>
    ...
    $('#user-form').on('submit', (e) => {
        ...
        $.post(`{{url('users')}}${append}`, formJSON, (res, status) => {
            modal.close()
            table.ajax.reload();
